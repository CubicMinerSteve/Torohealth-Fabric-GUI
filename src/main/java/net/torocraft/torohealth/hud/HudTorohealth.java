...
public class HudTorohealth extends Screen {
	...
	public void draw(GuiGraphics graphics, Config config) {
	...
	private void drawHud(GuiGraphics graphics, float xPos, float yPos, float hudScale) {
		if (entity == null) {
			return;
		}
	...
	private void drawEntity(GuiGraphics graphics, float xPos, float yPos, float hudScale) {
