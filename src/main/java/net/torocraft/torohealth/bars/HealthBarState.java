...
import net.torocraft.torohealth.particles.DamageParticleRenderer;
...
public class HealthBarState {
	...
	public void tick() {
		health = (float) Math.min(entity.getHealth(), EntityUtils.limitlessAttribute(entity, Attributes.MAX_HEALTH));
		incrementTimers();
